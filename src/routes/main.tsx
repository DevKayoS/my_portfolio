  ...
  return( 
      <div className="lg:max-w-[1200px] m-auto flex items-center justify-center ">
        <motion.div 
          ...
          initial="hidden"
          animate="visible"
          className="shadow-xl shadow-black h-96  border-zinc-800 justify-center max-w-[800px] mt-24 text-zinc-400  md:p-8 md:rounded-lg  flex flex-col  font-sans  bg-zinc-950/95">

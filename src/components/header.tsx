...
export function Header(){
  return(
    <div className="lg:w-full w-[780px]  bg-zinc-800 h-16  flex fixed ">
      
      <div className='w-72 ml-8 flex-row gap-2  mr-56 flex justify-center'>
      ...
      <div className='flex w-full lg:justify-end text-zinc-500 gap-3 text-sm items-center mr-4'>

...
export function Stacks() {
  ...
  <div className="lg:h-px bg-zinc-800"/>
    <div id='stacks' className=' flex flex-col h-[100vh]  text-slate-50'>
        ...
        <div className='lg:grid lg:grid-cols-2 gap-52 max-w-[1500px]'>
          <div className=' flex gap-3 lg:w-[600px] w-96 p-4 justify-center rounded-md shadow-lg shadow-purple-600  ml-32 items-center  bg-zinc-500/30'>
          <div >  
      ...
      <div className=' flex gap-3 mt-10 ml-32 w-96 p-4 justify-center rounded-md shadow-lg shadow-purple-600 flex-col  items-center cursor-pointer bg-zinc-500/30'>
      <div >
